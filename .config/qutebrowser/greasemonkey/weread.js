...
/* 顶部工具栏 */
GM_addStyle(".readerTopBar{max-width:100%; font-family: 'Inziu Iosevka SC','KaiTi' !important;}");
/* 书标题 */
GM_addStyle(".readerTopBar_title .readerTopBar_title_link{font-family: 'Inziu Iosevka SC','KaiTi'; !important; font-weight:bold !important;}");
/* 当前章节标题 */
GM_addStyle(".readerTopBar_title .readerTopBar_title_chapter{font-family: 'Inziu Iosevka SC','KaiTi' !important;}");
/* 去书架查看 */
GM_addStyle(".readerTopBar_actions .addShelfItem{font-family: 'Inziu Iosevka SC','KaiTi' !important;}");
...
/* 笔记 */
GM_addStyle(".readerNotePanel .selectionListItem{border:5px solid  #f00; font-family: 'Inziu Iosevka SC','KaiTi';!important;}");

/* 目录 */
GM_addStyle(".readerCatalog h2.readerCatalog_bookInfo_title .readerCatalog_bookInfo_title_txt{font-family: 'Inziu Iosevka SC','KaiTi' !important;}");
GM_addStyle(".readerCatalog ul.readerCatalog_list li.chapterItem span.chapterItem_text{font-family: 'Inziu Iosevka SC','KaiTi' !important;}");
//GM_addStyle(".readerCatalog ul.readerCatalog_list li.chapterItem_current{border:5px solid #ccc; font-family: 'Inziu Iosevka SC','KaiTi' !important;}");
GM_addStyle(".readerCatalog ul.readerCatalog_list li.chapterItem_current span.chapterItem_text{font-family:  'Inziu Iosevka SC','KaiTi' !important;}");
/* 目录-滚动条（隐藏） */
GM_addStyle(".readerCatalog_list::-webkit-scrollbar {overflow: hidden ;position: relative ;display: none;};");

/* 下一页 */
GM_addStyle(".readerFooter .readerFooter_button {font-family: 'Inziu Iosevka SC','KaiTi';font-weight:bold !important;}");
