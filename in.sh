...
echo -e "-------------------------------------------------------------------------------" | center
echo -e "                                                                               " | center
echo -e "               ___  _   _  ____   _____     _     _      _                     " | center
echo -e "              |_ _|| \ | |/ ___| |_   _|   / \   | |    | |                    " | center
echo -e "               | | |  \| |\___ \   | |    / _ \  | |    | |                    " | center
echo -e "               | | | |\  | ___) |  | |   / ___ \ | |___ | |___                 " | center
echo -e "              |___||_| \_||____/   |_|  /_/   \_\|_____||_____|                " | center
echo -e "                                                                               " | center
echo -e "                                                                               " | center
echo -e "-------------------------------------------------------------------------------" | center
echo -e "              TaoTao - Saber - Debian - Desktop - Install                      " | center
echo -e "-------------------------------------------------------------------------------" | center
echo -e "                                                                               " | center
