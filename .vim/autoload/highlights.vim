function! highlights#SystemHighlights() abort
    highlight Search            TERM=STANDOUT  CTERM=BOLD  CTERMFG=235  CTERMBG=204  GUIFG=#000000  GUIBG=#EA656F 
    highlight IncSearch         TERM=STANDOUT  CTERM=BOLD  CTERMFG=1    CTERMBG=1    GUIFG=#000000  GUIBG=#E0AF68 
    highlight Folded            TERM=STANDOUT  CTERM=BOLD  CTERMFG=0    CTERMBG=5    GUIFG=#282C34  GUIBG=#E0AF68 
    highlight FoldColumn        TERM=STANDOUT  CTERM=BOLD  CTERMFG=0    CTERMBG=5    GUIFG=#5a6378  GUIBG=#282C34 
